...
<body>
    ...
    <table class="table table-hover table-striped">
        ...
        <tbody>
            <?php 
            include "koneksi.php";
            $qry_siswa = mysqli_query($db, "SELECT * FROM siswa JOIN kelas ON kelas.id_kelas = siswa.id_kelas");
            $no = 0;
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-gtEjrD/SeCtmISkJkNUaaKMoLD
